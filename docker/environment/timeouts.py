...
MINUTE = 60
APPMOCK_WAIT_FOR_NAGIOS_SECONDS = 30
CEPH_READY_WAIT_SECONDS = 5 * MINUTE
WEBDAV_READY_WAIT_SECONDS = 5 * MINUTE
XROOTD_READY_WAIT_SECONDS = 5 * MINUTE
HTTP_READY_WAIT_SECONDS = 5 * MINUTE
SWIFT_READY_WAIT_SECONDS = 5 * MINUTE
GLUSTERFS_READY_WAIT_SECONDS = 5 * MINUTE
NFS_READY_WAIT_SECONDS = 5 * MINUTE
COUCHBASE_READY_WAIT_SECONDS = 5 * MINUTE
DNS_WAIT_SECONDS = 1 * MINUTE
