...
from environment import xrootd, common, dockers_config

parser = argparse.ArgumentParser(
    formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    description='Bring up XRootD server.')
...
dockers_config.ensure_image(args, 'image', 'xrootd')

config = xrootd.up(args.image, 'storage', args.uid)
